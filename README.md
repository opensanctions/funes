...
Funes turns the internet into lists of politicians. It orchestrates web capture (via the in-process [Pravda](https://github.com/opensanctions/pravda) async library), LLM extraction, and JSONL output to pull political position holders out of web pages.
...
Funes does not persist extraction results in PostgreSQL. Pravda still stores the captured evidence and snapshot metadata there.
